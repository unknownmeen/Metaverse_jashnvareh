    ...
    <Dialog onOpenChange={handleClose} open={open}>
      <DialogContent className="max-w-md rounded-3xl p-6" dir="rtl">
        <DialogHeader className="text-right">
          <DialogTitle className="text-right">ایجاد تصویر جدید</DialogTitle>
          <DialogDescription className="text-right">
            {step === "upload"
              ? "فایل را به اینجا بکشید یا برای انتخاب کلیک کنید. حداکثر حجم فایل ۱۰ مگابایت."
              : "عنوان و توضیحات تصویر را وارد کنید."}
          </DialogDescription>
        </DialogHeader>
            ...
            >
              ...
              <label className="flex cursor-pointer flex-col items-center gap-2 text-center" htmlFor="image-upload-input">
                ...
                <span className="text-sm font-medium text-slate-600">
                  ...
                  <span className="text-primary-600 underline decoration-primary-500">برای انتخاب کلیک کنید</span>
                </span>
                <span className="text-xs text-slate-400">حداکثر حجم فایل ۱۰ مگابایت</span>
                <span className="text-xs text-slate-400">شما حداکثر سه عکس می‌توانید بارگذاری کنید</span>
              </label>
            </div>
